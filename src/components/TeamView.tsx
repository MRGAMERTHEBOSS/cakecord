...
const TEAM_MEMBERS = [
  {
    ...
    desc: "Hey I'm Connor, the Founder and Lead Developer of Cakecord. I help operate Cakecord and make sure everything runs smoothly.",
            ...
            >
              <div>
                ...
                <div className="flex items-center gap-4 mb-5">
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-tr ${member.color} flex items-center justify-center font-black text-white text-lg shadow-lg`}>
